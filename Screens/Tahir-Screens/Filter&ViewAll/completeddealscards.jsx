      ...
      >
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalContent}>
            ...
            >
              {item.seller === user._id ? "Buyer Details" : "Seller Details"}
            </Text>
            <View
              style={{
                display: "flex",
              ...
              <View>
                <View style={{ alignItems: "flex-start", marginBottom: 10 }}>
                  <Text style={styles.topBidText}>
                    {item.seller === user._id ? "Bought By" : "Sold By"}
                  </Text>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.detailsRow}>
          <View style={styles.iconTextContainer}>
            <Icon name="calendar" type="feather" size={12} color="#000000" />
        ...
        <View>
          ...
          <Text style={styles.priceText}>
            AED {formatAmount(item.buyingAmount)}
          </Text>
        </View>
        ...
        <View style={styles.bottomRow}>
          ...
          <TouchableOpacity style={styles.viewAdButton} onPress={handleChatNow}>
            <Icon name="chat" type="material" size={14} color="#FFFFFF" />
            <Text style={styles.viewAdButtonText}>
